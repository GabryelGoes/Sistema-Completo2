...
export const WorkshopTechniciansModal: React.FC<WorkshopTechniciansModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-xl p-2 sm:p-4 animate-modal-backdrop">
      <div className="bg-white/95 dark:bg-[#1C1C1E]/95 backdrop-blur-xl border-0 rounded-[1.5rem] w-full max-w-3xl h-[92vh] max-h-[92vh] shadow-none overflow-hidden animate-modal-sheet flex flex-col">
