...
const vehicleModalCompactCardGrid =
  'gap-2 sm:gap-2.5 portrait:gap-[4.6px] portrait:sm:gap-[5.75px]';
const vehicleModalCompactCardRow =
  'relative flex items-center gap-2 px-2.5 py-2 sm:gap-2.5 sm:px-3 sm:py-2.5 portrait:gap-[4.6px] portrait:px-[1.73px] portrait:py-[1.15px] portrait:sm:gap-[5.75px] portrait:sm:px-[2.3px] portrait:sm:py-[1.73px]';
const vehicleModalCompactCardSplitRow =
  'relative flex flex-col gap-[clamp(0.35rem,1.8vw,0.7rem)] px-2.5 py-2 sm:flex-row sm:items-center sm:gap-[clamp(0.5rem,1.2vw,1rem)] sm:px-3 sm:py-2.5 portrait:gap-[4.6px] portrait:px-[1.73px] portrait:py-[1.15px] portrait:sm:gap-[5.75px] portrait:sm:px-[2.3px] portrait:sm:py-[1.73px]';
...
const vehicleModalCompactCardTitleText =
  'bg-gradient-to-r from-zinc-950 via-zinc-800 to-zinc-600 bg-clip-text text-[12px] font-bold leading-tight tracking-[-0.02em] text-transparent dark:from-white dark:via-zinc-100 dark:to-zinc-400 sm:text-[13px] portrait:text-[11.5px] portrait:sm:text-[12.2px]';
const vehicleModalCompactCardBodyText =
  'mt-0.5 truncate text-[12px] font-semibold leading-tight text-zinc-900 dark:text-white portrait:text-[11.5px]';
const vehicleModalCompactCardAssignHint =
  'mt-0.5 text-[12px] font-semibold leading-tight text-[#007AFF] dark:text-[#7ab8ff] portrait:text-[11.5px]';
...
const vehicleModalCompactCardNumericInput =
  'min-w-0 flex-1 rounded-xl border border-zinc-300/90 bg-zinc-50 px-2.5 py-1.5 text-[13px] tabular-nums text-zinc-950 shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)] placeholder:text-zinc-400 focus:border-[#007AFF]/50 focus:outline-none focus:ring-2 focus:ring-[#007AFF]/25 dark:border-white/[0.12] dark:bg-zinc-950/50 dark:text-white dark:placeholder:text-zinc-500 sm:max-w-[180px] sm:flex-none portrait:rounded-md portrait:px-[1.73px] portrait:py-[0.58px] portrait:text-[12.2px] portrait:focus:ring-1';
const vehicleModalCompactCardDateInput =
  'min-w-0 flex-1 rounded-xl border border-zinc-300/90 bg-zinc-50 px-2.5 py-1.5 text-[13px] tabular-nums text-zinc-950 shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)] focus:border-[#007AFF]/50 focus:outline-none focus:ring-2 focus:ring-[#007AFF]/25 dark:border-white/[0.1] dark:bg-zinc-950/50 dark:text-white sm:max-w-[180px] sm:flex-none portrait:rounded-md portrait:px-[1.73px] portrait:py-[0.58px] portrait:text-[12.2px] portrait:focus:ring-1';
const vehicleModalCompactCardSaveBtn =
  'inline-flex shrink-0 items-center gap-1 rounded-xl px-2.5 py-1.5 text-[12px] font-semibold text-white shadow-md transition-all disabled:opacity-50 portrait:gap-[0.58px] portrait:rounded-md portrait:px-[1.73px] portrait:py-[0.58px] portrait:text-[11.5px]';
const vehicleModalCompactCardSaveIcon = 'h-3.5 w-3.5 portrait:h-2.5 portrait:w-2.5';
const vehicleModalCompactCardSalvo =
  'text-[11px] font-semibold text-green-600 dark:text-green-400 portrait:text-[10.35px]';
...
const vehicleModalCompactCardFieldRow =
  'flex min-w-0 flex-1 flex-wrap items-center gap-1.5 sm:ml-auto sm:justify-end portrait:gap-[0.58px]';
