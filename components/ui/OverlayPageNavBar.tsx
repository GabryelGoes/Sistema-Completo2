...
/**
 * Botão "Voltar" fixo em páginas abertas pela Home (fora da aba Início).
...
export function OverlayPageNavBar({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-30 flex items-start px-4 pt-[max(0.75rem,env(safe-area-inset-top))]">
      <button
        type="button"
        onClick={onBack}
