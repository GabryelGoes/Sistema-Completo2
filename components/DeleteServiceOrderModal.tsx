...
/** Confirmação para remover OS apenas da visualização dos relatórios (sem alterar o banco). */
      ...
      >
        ...
        >
          ...
          <p className="mb-4 text-[14px] leading-relaxed text-zinc-600 dark:text-zinc-400">
            A OS <strong className="text-zinc-800 dark:text-zinc-200">{orderLabel}</strong> deixará de aparecer
            neste centro de relatórios. A ordem <strong>permanece no sistema e no banco de dados</strong> (Pátio,
            recepção, etc.).
          </p>
