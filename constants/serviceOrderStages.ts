...
export const SERVICE_ORDER_STAGES: StageConfig[] = [
  ...
  { id: "AGUARDANDO_APROVACAO", name: "Aguardando aprovação", style: "bg-amber-400 text-amber-950 border-amber-500", ringClass: "ring-2 ring-amber-500 ring-offset-2 ring-offset-zinc-50 dark:ring-offset-[#0a0a0a]", pos: 3 },
